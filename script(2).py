# Erstelle das moderne CSS mit allen 2025 Trends

css_content = """/* =================================
   MODERNE PHYSIK WEBSITE 2025
   Mit Glasmorphismus & Dark Mode
   ================================= */
...
:root {
    ...
    --gradient-text: linear-gradient(135deg, var(--accent-blue), var(--accent-pink));
...
# Schreibe die neue CSS-Datei
with open('styles.css', 'w', encoding='utf-8') as f:
    f.write(css_content)

print("🎨 Modernes CSS erstellt!")
print("\n✨ Styling-Features:")
print("• Glasmorphismus-Effekte mit Backdrop-Filter") 
print("• Responsive Grid-Layouts")
print("• Smooth Animations & Transitions")
print("• Modern Typography mit Inter & JetBrains Mono")
print("• CSS Custom Properties für Theme-System")
print("• Mobile-First Responsive Design")
print("• Accessibility-Features")
print("• Print-Optimierung")